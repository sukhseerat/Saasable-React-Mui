...
import Intelli from "../components/Intelli";
import Simple from "../components/Simple";
import Tailored from "../components/Tailored";
import Real from "../components/Real";
import Upgrade from "../components/Upgrade";
import Affordable from "../components/Affordable";
import Rescenter from "../components/ResCenter";
import FrequentlyTwo from "../components/FrequentlyTwo";
  ...
  return (
    <Container maxWidth="lg" style={{ backgroundColor: "#131417", color: "white", minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
      <Grid container spacing={4} style={{ maxWidth: "80%" }}>
        {/* Main Section */}
        <Grid container item spacing={6} alignItems="center" sx={{ padding: 1,  }}>
          {/* Left Container */}
